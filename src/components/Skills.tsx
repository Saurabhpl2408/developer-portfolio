...
import { useTheme } from "next-themes"; // or wherever your theme hook is
            ...
            <div key={category} className="animate-fade-in-up" style={{ animationDelay: `${categoryIndex * 100}ms` }}>
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
                {items.map((skill) => {
                  ...
                  const IconComponent = SiIcons[skill.icon as keyof typeof SiIcons] as IconType;
                  
                  // Adjust color based on theme for black icons
                  let iconColor = skill.color;
                  if (skill.color === "#000000" && theme === "dark") {
                    iconColor = "#FFFFFF";
                  }
